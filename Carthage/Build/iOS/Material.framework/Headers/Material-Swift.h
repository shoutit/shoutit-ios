...
@property (nonatomic, copy) void (^ _Nullable handleFABButtonCallback)(UIButton * _Nonnull);
...
/// Open the Menu component with animation options.
/// \param isTriggeredByUserInteraction A boolean indicating whether the
...
/// \param completion A completion block to execute on each view’s animation.
///
- (void)openWithIsTriggeredByUserInteraction:(BOOL)isTriggeredByUserInteraction duration:(NSTimeInterval)duration delay:(NSTimeInterval)delay usingSpringWithDamping:(CGFloat)usingSpringWithDamping initialSpringVelocity:(CGFloat)initialSpringVelocity options:(UIViewAnimationOptions)options animations:(void (^ _Nullable)(UIView * _Nonnull))animations completion:(void (^ _Nullable)(UIView * _Nonnull))completion;
...
/// \param completion A completion block to execute on each view’s animation.
///
- (void)closeWithIsTriggeredByUserInteraction:(BOOL)isTriggeredByUserInteraction duration:(NSTimeInterval)duration delay:(NSTimeInterval)delay usingSpringWithDamping:(CGFloat)usingSpringWithDamping initialSpringVelocity:(CGFloat)initialSpringVelocity options:(UIViewAnimationOptions)options animations:(void (^ _Nullable)(UIView * _Nonnull))animations completion:(void (^ _Nullable)(UIView * _Nonnull))completion;
@end
...
enum FABMenuItemTitleLabelPosition : NSInteger;
...
/// The titleLabel side.
@property (nonatomic) enum FABMenuItemTitleLabelPosition titleLabelPosition;
...
/// A delegation reference.
@property (nonatomic, weak) id <TabsControllerDelegate> _Nullable delegate;
