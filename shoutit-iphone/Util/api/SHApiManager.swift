...
class SHApiManager: NSObject {
    ...
    func get<R: Mappable>(url: String, params: [String : AnyObject]?, cacheKey: String? = nil, cacheResponse: R -> Void, completionHandler: Response<R, NSError> -> Void) {
    ...
    func post<R: Mappable>(url: String, params: [String : AnyObject]?, cacheKey: String? = nil, cacheResponse: R -> Void, completionHandler: Response<R, NSError> -> Void) {
