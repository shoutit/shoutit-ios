...
//    CGFloat separatorLineInterval = self.frame.size.width / _numOfMenu;
   ...
   //NSMutableArray *tempIndicators = [[NSMutableArray alloc] initWithCapacity:_numOfMenu];
    NSMutableArray *tempBgLayers = [[NSMutableArray alloc] initWithCapacity:(NSUInteger)_numOfMenu];
...
-(void)present
{
    [self animateBackGroundView:self.backGroundView show:YES complete:
     ^{
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    if (self.delegate || [self.delegate respondsToSelector:@selector(menu:didSelectRowAtIndexPath:)]) {
        ...
        [self.delegate menu:self didSelectRowAtIndexPath:[DOPIndexPath indexPathWithCol:indexPath.section row:indexPath.row]];
    } else {
